...
//         console.log(alpha4.length)
    ...
    // alpha     --> Randomly generated letters
    // alpha3    --> Letters that need to be removed from "alpha"
    // alpha4    --> Final set of letters for the user to play 
    // Words     --> Dictionary
    // wordList  --> Words Generated from the Dictionary for the user to play