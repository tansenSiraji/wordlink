...
var alpha = [], alpha1 = [], alpha2 = [], alpha3 = [],  alpha5 = []
class GameScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {box1 : '', box2: '', box3: '', alpha4: [], storeWord: [], splitMatchedWord: [], wordList: [], wordListLength: 0, wordListLengthArray: []}
...
wordBoxGenerator(){
  ...
  alphabetGenerator(){
    ...
    console.log("Generated Words:", this.state.wordList)
