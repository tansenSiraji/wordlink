...
var alpha = [], alpha1 = [], alpha2 = [], alpha3 = [],  alpha5 = [], wordList = [], wordStack = {}, wordList2 = []
      ...
      console.log(wordStack, "wordStack")
        return word2.map((data, key) => {
          ...
          return (
            ...
            <View key = {index} style = {styles.middle} ><Text style={{ fontSize: 20, fontWeight: 'bold', justifyContent: 'center', textAlignVertical: 'center', textAlign: 'center', borderWidth: 5 }}>{data}</Text></View>
            </View>
        ...
        <View style={{
          ...
          <View style={{
            ...
            {wordList.map((data, key) => {
              ...
              var index = key
              var word = data.split()
              return <View style = {{flexDirection: "row",}}>{this.wordBoxGenerator(word)}</View>
            })}
