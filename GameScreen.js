...
var alpha = [], alpha1 = [], alpha2 = [], alpha3 = [],  alpha5 = [], wordList = [], splitMatchedWord = []
class GameScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {box1 : '', box2: '', box3: '', alpha4: [], storeWord: []}
        ...
        <View style={{
          ...
          <View style={{
            ...
            <View style={styles.middle}>
              <Text style={{ fontSize: 30, fontWeight: 'bold', justifyContent: 'center', textAlignVertical: 'center', textAlign: 'center' }}>{splitMatchedWord[0]}</Text>
            </View>
            <View style={styles.middle}>
              <Text style={{ fontSize: 30, fontWeight: 'bold', justifyContent: 'center', textAlignVertical: 'center', textAlign: 'center' }}>{splitMatchedWord[1]}</Text>
            </View>
            <View style={styles.middle}>
              <Text style={{ fontSize: 30, fontWeight: 'bold', justifyContent: 'center', textAlignVertical: 'center', textAlign: 'center' }}>{splitMatchedWord[2]}</Text>
            </View>
            <View style={styles.middle}>
              <Text style={{ fontSize: 30, fontWeight: 'bold', justifyContent: 'center', textAlignVertical: 'center', textAlign: 'center' }}>{splitMatchedWord[3]}</Text>
            </View>
          </View>
        </View>
